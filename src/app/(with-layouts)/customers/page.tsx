    ...
    <div className="space-y-6">
      ...
      {isPending ? (
        ...
        <SmallTable
          ...
          tabHideKeys={["ulid", "id", "name", "vat_id", "properties", "created_at", "updated_at", "deleted_at", "province_id", "regency_id", "parent_id", "admin_id", "type", "user_id", "customer_id", "is_active"]}
          renderHeader={(it) => (
