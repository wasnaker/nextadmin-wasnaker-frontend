...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@wasnaker/web-core", "@wasnaker/customers-web", "@wasnaker/region-web", "@wasnaker/vat-web", "@wasnaker/surveyor-web", "@wasnaker/association-web", "@wasnaker/agency-web", "@wasnaker/home-web", "@wasnaker/connect-web", "@wasnaker/connections-web"],
};
